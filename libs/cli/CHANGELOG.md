...
## [0.2.3](https://github.com/developerjeremylive-git/deepagents-etheroi-/compare/deepagents-cli==0.2.2...deepagents-cli==0.2.3) (2026-07-02)


### Bug Fixes

* **cli:** support `state` deploy backend ([#3790](https://github.com/developerjeremylive-git/deepagents-etheroi-/issues/3790)) ([04b4bb9](https://github.com/developerjeremylive-git/deepagents-etheroi-/commit/04b4bb946fc5ff914b8cccc8c9543d10533de0f8))
